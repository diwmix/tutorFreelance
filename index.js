...
app.get('/profile', async (req, res) => {
  if (req.session.user) {
    res.render('profile', { name: req.session.user.username, id: req.session.user.id, avatar: req.session.user.avatar, bio: req.session.user.bio})
  }
  else {
...
app.post('/profile', upload.single('file'), userSettingsController.userSettings)
